...
async def help(ctx):
 ...
 embed.set_author(name="Hosted By Lil Javion", icon_url="https://media.discordapp.net/attachments/749509994944397313/768927146227400714/image0.gif")
 embed.set_image(url="https://media.discordapp.net/attachments/749509994944397313/768849639557300264/image0.gif")

 embed.add_field(name="__**> OVERVIEW**__", value="this bot was developed by ٴٴ#0171, for help, contact them on discord.", inline=True)
...
async def wizz(ctx):
    ...
    show_avatar.set_image(url='https://media.discordapp.net/attachments/749509994944397313/760489229737394216/image0_33.gif')
...
async def banall(ctx):
    await ctx.message.delete()
    await ctx.send("Tro Was Here")
    show_avatar = discord.Embed(

     color=ctx.author.color 
    )
    show_avatar.set_image(url='https://media.discordapp.net/attachments/749509994944397313/759964556734365746/ezgif.com-optimize_1_2.gif')
    await ctx.send(embed=show_avatar)
